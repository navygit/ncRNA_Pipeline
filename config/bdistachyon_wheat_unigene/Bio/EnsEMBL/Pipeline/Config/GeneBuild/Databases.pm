...
%Databases = (
	      ...
	      GB_DBHOST                  => 'mysql-cluster-eg-prod-2.ebi.ac.uk',
	      GB_DBNAME                  => 'brachypodium_distachyon_core_17_70_12',
	      GB_DBUSER                  => 'ensrw',
	      GB_DBPASS                  => 'writ3rp2',
	      GB_DBPORT                  => '4239',
	      # database containing the genewise genes (TGE_gw,similarity_genewise)
              GB_GW_DBHOST               => 'mysql-cluster-eg-prod-2.ebi.ac.uk',
              GB_GW_DBNAME               => 'brachypodium_distachyon_core_17_70_12',
              GB_GW_DBUSER               => 'ensrw',
              GB_GW_DBPASS               => 'writ3rp2',
              GB_GW_DBPORT               => '4239',
	      ...
	      GB_BLESSED_DBHOST          => 'mysql-cluster-eg-prod-2.ebi.ac.uk',
	      GB_BLESSED_DBNAME          => 'brachypodium_distachyon_core_17_70_12',
	      GB_BLESSED_DBUSER          => 'ensrw',
	      GB_BLESSED_DBPASS          => 'writ3rp2',
	      GB_BLESSED_DBPORT          => '4239',
	      #GB_BLESSED_DBHOST          => '',
	      #GB_BLESSED_DBNAME          => '',
	      #GB_BLESSED_DBUSER          => '',
	      #GB_BLESSED_DBPASS          => '',
	      ...
	      GB_COMB_DBHOST             => 'mysql-cluster-eg-prod-2.ebi.ac.uk',
	      GB_COMB_DBNAME             => 'brachypodium_distachyon_core_17_70_12',   #Was: kmegy_culex3_gw_combine_42 - this one is for a test!
	      GB_COMB_DBUSER             => 'ensrw',
	      GB_COMB_DBPASS             => 'writ3rp2',
	      GB_COMB_DBPORT             => '4239',
	      ...
	      #GB_cDNA_DBHOST             => 'mysql-cluster-eg-prod-2.ebi.ac.uk',
	      #GB_cDNA_DBNAME             => 'kmegy_culex3_estbuild_42', / 'kmegy_culex3_estbuild2_42', / 'kmegy_culex3_estbuild_broad__42',
	      #GB_cDNA_DBUSER             => 'ensrw',
	      #GB_cDNA_DBPASS             => 'writ3rp2',
              #GB_cDNA_DBPORT             => '4239',

	      #Clean EST database
	      GB_cDNA_DBHOST             => 'mysql-cluster-eg-prod-2.ebi.ac.uk',
	      GB_cDNA_DBNAME             => 'brachypodium_distachyon_core_17_70_12',
	      GB_cDNA_DBUSER             => 'ensrw',
	      GB_cDNA_DBPASS             => 'writ3rp2',
              GB_cDNA_DBPORT             => '4239',

	      # db to put pseudogenes in
	      PSEUDO_DBHOST              => 'mysql-cluster-eg-prod-2.ebi.ac.uk',
	      PSEUDO_DBNAME              => 'brachypodium_distachyon_core_17_70_12',
	      PSEUDO_DBUSER              => 'ensrw',
	      PSEUDO_DBPASS              => 'writ3rp2',
              PSEUDO_DBPORT              => '4239',

	      # this db needs to have clone & contig & static_golden_path tables populated        #For GeneBuild
	      GB_FINALDBHOST             => 'mysql-cluster-eg-prod-2.ebi.ac.uk',                                         # ...see Incremental config files
	      GB_FINALDBNAME             => 'brachypodium_distachyon_core_17_70_12',
	      GB_FINALDBUSER             => 'ensrw',
	      GB_FINALDBPASS             => 'writ3rp2',
              GB_FINALDBPORT             => '4239',
	     );
