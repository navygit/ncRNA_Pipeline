...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
      DEFAULT => {
        ...
        GENOMICSEQS         => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/bdistachyon/toplevel.fa',

        QUERYTYPE           => 'dna',
        QUERYSEQS           => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/bdistachyon/est_chunks',
      ...
      est_exonerate => {
        ...
        OPTIONS             => "--model est2genome --forwardcoordinates FALSE "
          . "--softmasktarget TRUE --exhaustive FALSE --score 300 "
          . "--saturatethreshold 10 --dnahspthreshold 60 --dnawordlen 12 "
          . "--fsmmemory 2048 --bestn 10 --maxintron 35000",
      },
      ...
      CDNA_logic_name => {
        ...
        OPTIONS => "--model est2genome --forwardcoordinates FALSE "
                ...
                . "--saturatethreshold 100 --dnahspthreshold 60 --dnawordlen 14 --fsmmemory 800 "
                . "--bestn 100 --maxintron 3000",
