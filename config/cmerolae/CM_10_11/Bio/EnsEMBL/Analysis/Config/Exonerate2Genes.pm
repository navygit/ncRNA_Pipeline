...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
      DEFAULT => {
        ...
        GENOMICSEQS         => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/toplevel.fa',

        QUERYTYPE           => 'dna',
        QUERYSEQS           => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/est_chunks',
