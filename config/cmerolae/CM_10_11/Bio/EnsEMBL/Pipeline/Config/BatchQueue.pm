...
%Config = (
  ...
  DEFAULT_RESOURCE    => '',
  DEFAULT_SUB_ARGS => '',
  DEFAULT_OUTPUT_DIR  => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature',
  DEFAULT_CLEANUP     => 'no',	
  ...
  QUEUE_CONFIG => [
    {
      ...
      runner     => '',
      queue => 'production',
      output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature',
      verbosity => 'INFO',
    ...
    },
 {
     ...
     runner     => '',
     cleanup => 'no',
     output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Scanprosite',
     runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
     verbosity => 'INFO',
     retry_queue => 'production',
     retry_resource => '',
     retry_sub_args => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Prints',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Pfscan',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Pfam',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/SigP',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Seg',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Tmhmm',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Ncoils',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  queue      => 'production',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Tigrfam',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  queue      => 'production',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/Superfamily',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  queue      => 'production',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/nobackup/ensemblgenomes/uma/release-12/protist/cmerolae/otherfeature/pirsf',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  retry_sub_args => '',
