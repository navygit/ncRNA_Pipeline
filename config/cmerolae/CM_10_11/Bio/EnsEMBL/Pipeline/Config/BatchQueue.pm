...
%Config = (
  ...
  DEFAULT_RESOURCE    => '',
  DEFAULT_SUB_ARGS => '',
  DEFAULT_OUTPUT_DIR  => '/nfs/nobackup/ensemblgenomes/production/dna_pipelines/data/cmerolae/',
  DEFAULT_CLEANUP     => 'no',	
  ...
  QUEUE_CONFIG => [
    {
      ...
      output_dir => '/nfs/nobackup/ensemblgenomes/production/dna_pipelines/data/cmerolae/',
      verbosity => 'INFO',
    ...
    },
 {
     ...
     runner     => '',
     cleanup => 'no',
     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Scanprosite',
     runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
     verbosity => 'INFO',
     retry_queue => 'production-rh6',
     retry_resource => '',
     retry_sub_args => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Prints',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Pfscan',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Pfam',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/SigP',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Seg',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Tmhmm',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Ncoils',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  ...
	  queue      => 'production-rh6',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Tigrfam',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  queue      => 'production-rh6',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/Superfamily',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  retry_resource => '',
	  retry_sub_args => '',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/smart',
      },
      {
	  logic_name => 'pirsf',
	  batch_size => 50,
	  ...
	  queue      => 'production-rh6',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/cmerolae/pirsf',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  retry_sub_args => '',
			 ...
			 logic_name => 'est_exonerate',
                         ...
                         runner     => '',
                         queue => 'production',
                         output_dir => '/nfs/nobackup/ensemblgenomes/production/est_pipelines/data/cmerolae/',
                         runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			 verbosity => 'INFO',
