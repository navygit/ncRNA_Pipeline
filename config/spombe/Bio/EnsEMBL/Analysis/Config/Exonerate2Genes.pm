...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
      DEFAULT => {
        ...
        GENOMICSEQS         => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/spombe/toplevel.fa',

        QUERYTYPE           => 'dna',
        QUERYSEQS           => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/spombe/est_chunks',
      ...
      EST_exonerate => {
        ...
        OPTIONS             => "--model est2genome --forwardcoordinates FALSE "
          ...
          . "--fsmmemory 800 --bestn 100 --maxintron 1000",
      },
