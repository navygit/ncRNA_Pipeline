...
%Config = (
  ...
  DEFAULT_RETRIES     => 3,
  DEFAULT_BATCH_QUEUE => 'production-rh6', # put in the queue  of your choice, eg. 'normal'
  DEFAULT_RESOURCE    => '',
  DEFAULT_SUB_ARGS => '',
  DEFAULT_OUTPUT_DIR  => '/nfs/nobackup/ensemblgenomes/production/dna_pipelines/data/creinhardtii',
  DEFAULT_CLEANUP     => 'no',	
  ...
  QUEUE_CONFIG => [
    {
      ...
      output_dir => '/nfs/nobackup2/ensemblgenomes/development/arnaud/dna_pipelines/data/creinhardtii',
      verbosity => 'INFO',
    ...
    },
 {
     ...
     runner     => '',
     cleanup => 'no',
     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/data/creinhardtii/Scanprosite',
     runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
     verbosity => 'INFO',
     retry_queue => 'production-rh6',
     retry_resource => '',
     retry_sub_args => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/creinhardtii/Prints',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/creinhardtii/SigP',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production-rh6',
	  retry_resource => '',
