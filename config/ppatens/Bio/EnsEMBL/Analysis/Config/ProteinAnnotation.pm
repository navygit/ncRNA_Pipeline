...
%ProteinAnnotation = (
   ...
   PROTEINANNOTATION_CONFIG_BY_LOGIC => {
     ...
     DEFAULT => {
       ...
       BASE_DIR      => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/ppatens/protein_chunks/',
     },
     ...
     seg => {
       ...
       BASE_DIR      => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/ppatens/proteins/',
     },
     signalp => {
     },
     ncoils => {
