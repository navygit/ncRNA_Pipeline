...
%General = (
	    PA_PEPTIDE_FILE => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/ppatens/proteins/ppatens.pep', #path to dumped peptides
	    PA_CHUNKS_DIR => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/ppatens/protein_chunks', #path to directory chunks to be written
	    PA_CHUNK_SIZE => 100,
