...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
      DEFAULT => {
        ...
        GENOMICSEQS         => '/nfs/panda/ensemblgenomes/development/arnaud/est_pipeline/data/mtruncatula/toplevel.fa',

        QUERYTYPE           => 'dna',
        QUERYSEQS           => '/nfs/panda/ensemblgenomes/development/arnaud/est_pipeline/data/mtruncatula/est_chunks',
      ...
      est_exonerate => {
        ...
        OPTIONS             => "--model est2genome --forwardcoordinates FALSE "
          ...
          . "--fsmmemory 2048 --bestn 100 --maxintron 35000",
      },
