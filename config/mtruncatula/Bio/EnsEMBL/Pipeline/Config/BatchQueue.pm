...
%Config = (
	   ...
	   DEFAULT_OUTPUT_DIR  => '/nfs/panda/ensemblgenomes/development/arnaud/dna_pipelines/data/mtruncatula',
           DEFAULT_RESOURCE    => '',
           DEFAULT_SUB_ARGS => '',
	   DEFAULT_CLEANUP     => 'n',	
	   AUTO_JOB_UPDATE     => 1,
	   ...
	   QUEUE_CONFIG => [

			    {
			     ...
			     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/dna_pipelines/data/mtruncatula',
			     cleanup => 'yes',        
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/scanprosite',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/Pfscan',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },   
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/pfam',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/signalp',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/Seg',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/Tmhmm',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			     retry_sub_args => '',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/ncoils',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => 'production-rh6',
			     retry_resource => '',
			     retry_sub_args => '',
			    },
                            {
                             ...
                             queue      => 'production-rh6',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                             output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/Tigrfam',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			     retry_sub_args => '',
                           },
                           {
                            ...
                            queue      => 'production-rh6',
                            runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                            output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/Superfamily',
			    verbosity => 'INFO',
			    retry_queue => '',
			    retry_resource => '',
			    retry_sub_args => '',
			   ...
			   retry_resource => '',
			   retry_sub_args => '',
                           output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/smart',
                         },
                         {
                          logic_name => 'pirsf',
                          batch_size => 1,
                          ...
                          queue      => 'production-rh6',
                          runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                          output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/protein_pipelines/data/mtruncatula/pirsf',
			  verbosity => 'INFO',
			  retry_queue => '',
			  retry_resource => '',
			  retry_sub_args => '',
			 ...
			 logic_name => 'est_exonerate',
                         ...
                         runner     => '',
                         queue => 'production-rh6',
                         output_dir => '/nfs/panda/ensemblgenomes/development/arnaud/est_pipeline/data/mtruncatula',
                         runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			 verbosity => 'INFO',
			 retry_queue => 'production-rh6',
			 retry_resource => '',
