...
%ProteinAnnotation = (
   ...
   PROTEINANNOTATION_CONFIG_BY_LOGIC => {
     ...
     DEFAULT => {
       ...
       BASE_DIR      => '/nfs/nobackup2/ensemblgenomes/production/'.$ENV{'USER'}.'protein_pipelines/data/adarlingi/protein_chunks/',
     },
     ...
     seg => {
       ...
       BASE_DIR      => '/nfs/nobackup2/ensemblgenomes/'.$ENV{'USER'}.'/protein_pipelines/data/adarlingi/proteins/',
     },
     signalp => {
     },
     ncoils => {
