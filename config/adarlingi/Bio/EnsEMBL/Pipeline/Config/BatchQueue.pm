...
%Config = (
	   ...
	   DEFAULT_OUTPUT_DIR  => '/nfs/nobackup2/ensemblgenomes/'.$ENV{USER}.'/dna_pipelines/data/adarlingi',
           DEFAULT_RESOURCE    => '',
           DEFAULT_SUB_ARGS => '',
	   DEFAULT_CLEANUP     => 'n',	
	   AUTO_JOB_UPDATE     => 1,
	   ...
	   QUEUE_CONFIG => [

			    {
			     ...
			     output_dir => '/nfs/nobackup2/ensemblgenomes/'.$ENV{USER}.'/dna_pipelines/data/adarlingi',
			     cleanup => 'yes',        
			 ...
			 logic_name => 'est_exonerate',
                         ...
                         runner     => '',
                         queue => 'production-rh6',
                         output_dir => '/nfs/nobackup2/ensemblgenomes/'.$ENV{USER}.'/est_pipeline/data/adarlingi',
                         runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			 verbosity => 'INFO',
