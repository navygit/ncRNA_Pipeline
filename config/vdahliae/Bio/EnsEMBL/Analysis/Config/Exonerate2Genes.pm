...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
      DEFAULT => {
        ...
        GENOMICSEQS         => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/vdahliae/toplevel.fa',

        QUERYTYPE           => 'dna',
        QUERYSEQS           => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/vdahliae/est_chunks',
