...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
      DEFAULT => {
        ...
        GENOMICSEQS         => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/smoellendorffii/toplevel.fa',

        QUERYTYPE           => 'dna',
        QUERYSEQS           => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/smoellendorffii/est_chunks',
      ...
      EST_exonerate => {
        ...
        OPTIONS             => "--model est2genome --forwardcoordinates FALSE "
          ...
          . "--fsmmemory 800 --bestn 100 --maxintron 3000",
      },
