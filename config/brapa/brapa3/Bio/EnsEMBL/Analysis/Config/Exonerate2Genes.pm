...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
      DEFAULT => {
        ...
        GENOMICSEQS         => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/brapa3/toplevel.fa',

        QUERYTYPE           => 'dna',
        QUERYSEQS           => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/brapa3/est_chunks',
