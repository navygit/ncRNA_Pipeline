...
%ProteinAnnotation = (
   ...
   PROTEINANNOTATION_CONFIG_BY_LOGIC => {
     ...
     DEFAULT => {
       ...
       BASE_DIR      => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/brapa3/protein_chunks',
     },
     ...
     seg => {
       ...
       BASE_DIR      => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/brapa3/proteins',
     },
     signalp => {
     },
     ncoils => {
