...
%Config = (
  EXONERATE_CONFIG_BY_LOGIC => {
      DEFAULT => {
        ...
        GENOMICSEQS         => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/brapa2/toplevel.fa',

        QUERYTYPE           => 'dna',
        QUERYSEQS           => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/brapa2/est_chunks',
      ...
      est_exonerate => {
        ...
        OPTIONS             => "--model est2genome --forwardcoordinates FALSE "
          ...
          . "--fsmmemory 800 --bestn 100 --maxintron 20000",
      },
      ...
      CDNA_logic_name => {
        ...
        QUERYTYPE => 'dna',
        QUERYSEQS => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/pultimum/est_chunks',
        USE_KILL_LIST => 0,
