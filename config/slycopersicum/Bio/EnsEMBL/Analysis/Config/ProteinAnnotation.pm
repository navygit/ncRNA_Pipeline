...
%ProteinAnnotation = (
   ...
   PROTEINANNOTATION_CONFIG_BY_LOGIC => {
     ...
     DEFAULT => {
       ...
       BASE_DIR      => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/slycopersicum/protein_chunks',
     },
     ...
     seg => {
       ...
       BASE_DIR      => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/slycopersicum/proteins',
     },
     signalp => {
     },
     ncoils => {
