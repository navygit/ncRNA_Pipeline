...
%EST_GeneBuilder_Conf = (
	    ...
	    EST_GENE_RUNNER   => '/nfs/acari/jb16/cvs_checkout/ensembl-pipeline/scripts/EST/run_EST_GeneBuilder.pl',
    	    ...
    	    EST_TMPDIR        => '/esc2/scratch2/jb16/cerevisiae/genebuilder_results/',	    
	    ...
	    EST_REFDBNAME               => 'jb16_cerevisiae_genes',
	    EST_REFDBHOST               => 'ia64g',
	    EST_REFDBPORT               => '3306',
	    ...
	    # from, in order to use them for the EST_GeneBuilder
			 ...
			 EST_DBNAME                  => 'jb16_cerevisiae_genes',
			 EST_DBHOST                  => 'ia64g',
			 EST_DBPORT                  => '3306',
			 EST_DBUSER                  => 'ensadmin',
			 EST_DBPASS                  => 'ensembl',
	    ...
	    EST_GENE_DBNAME                  => 'jb16_cerevisia_ests',
	    EST_GENE_DBHOST                  => 'ia64g',
