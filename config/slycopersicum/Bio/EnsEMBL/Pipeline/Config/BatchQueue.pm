...
%Config = (
	   ...
	   DEFAULT_OUTPUT_DIR  => '/nfs/nobackup/ensemblgenomes/production/dna_pipelines/data/slycopersicum',
           DEFAULT_RESOURCE    => '',
           DEFAULT_SUB_ARGS => '',
	   DEFAULT_CLEANUP     => 'n',	
	   AUTO_JOB_UPDATE     => 1,
	   ...
	   QUEUE_CONFIG => [

			    {
			     ...
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/dna_pipelines/data/slycopersicum',
			     cleanup => 'yes',        
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/scanprosite',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/prints',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/Pfscan',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },   
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/pfam',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/signalp',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/Seg',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/Tmhmm',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			     retry_sub_args => '',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/ncoils',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => 'production-rh6',
			     retry_resource => '',
			     retry_sub_args => '',
			    },
                            {
                             ...
                             queue      => 'production-rh6',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                             output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/Tigrfam',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			     retry_sub_args => '',
                           },
                           {
                            ...
                            queue      => 'production-rh6',
                            runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                            output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/Superfamily',
			    verbosity => 'INFO',
			    retry_queue => '',
			    retry_resource => '',
			    retry_sub_args => '',
			   ...
			   retry_resource => '',
			   retry_sub_args => '',
                           output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/smart',
                         },
                         {
                          logic_name => 'pirsf',
                          batch_size => 1,
                          ...
                          queue      => 'production-rh6',
                          runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                          output_dir => '/nfs/nobackup/ensemblgenomes/production/protein_pipelines/data/slycopersicum/pirsf',
			  verbosity => 'INFO',
			  retry_queue => '',
			  retry_resource => '',
			  retry_sub_args => '',
			 ...
			 logic_name => 'est_exonerate',
                         ...
                         runner     => '',
                         queue => 'production-rh6',
                         output_dir => '/nfs/panda/ensemblgenomes/production/est_pipeline/data/slycopersicum',
                         runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			 verbosity => 'INFO',
			 retry_queue => 'production-rh6',
			 retry_resource => '',
