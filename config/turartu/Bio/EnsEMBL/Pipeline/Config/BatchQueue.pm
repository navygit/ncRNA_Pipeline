...
%Config = (
	   ...
	   QUEUE_CONFIG => [
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',         
			     output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/dna_pipelines/data/turartu',
			     runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/scanprosite',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/Pfscan',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },   
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/pfam',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/signalp',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/Seg',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/Tmhmm',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			     retry_sub_args => '',
			    ...
			    },    
			    {
			     ...
			     runner     => '',
			     cleanup => 'no',
			     output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/ncoils',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			     verbosity => 'INFO',
			     retry_queue => 'production-rh6',
			     retry_resource => '',
			     retry_sub_args => '',
			    },
                            {
                             ...
                             queue      => 'production-rh6',
                             runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                             output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/Tigrfam',
			     verbosity => 'INFO',
			     retry_queue => '',
			     retry_resource => '',
			     retry_sub_args => '',
                           },
                           {
                            ...
                            queue      => 'production-rh6',
                            runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                            output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/Superfamily',
			    verbosity => 'INFO',
			    retry_queue => '',
			    retry_resource => '',
			    retry_sub_args => '',
			   ...
			   retry_resource => '',
			   retry_sub_args => '',
                           output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/smart',
                         },
                         {
                          logic_name => 'pirsf',
                          batch_size => 1,
                          ...
                          queue      => 'production-rh6',
                          runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
                          output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/protein_pipelines/data/turartu/pirsf',
			  verbosity => 'INFO',
			  retry_queue => '',
			  retry_resource => '',
			  retry_sub_args => '',
			 ...
			 logic_name => 'est_exonerate',
                         ...
                         runner     => '',
                         queue => 'production-rh6',
                         output_dir => '/nfs/nobackup2/ensemblgenomes/arnaud/est_pipeline/data/turartu',
                         runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
			 verbosity => 'INFO',
			 retry_queue => 'production-rh6',
			 retry_resource => '',
