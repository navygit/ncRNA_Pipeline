...
%ProteinAnnotation = (
   ...
   PROTEINANNOTATION_CONFIG_BY_LOGIC => {
     ...
     DEFAULT => {
       ...
       BASE_DIR      => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/bdistachyon/protein_chunks/',
     },
     ...
     Seg => {
       ...
       BASE_DIR      => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/bdistachyon/proteins/',
     },
     Signalp => {
     },
     Ncoils => {
