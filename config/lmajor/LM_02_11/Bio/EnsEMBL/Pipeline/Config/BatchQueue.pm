...
%Config = (
  ...
  DEFAULT_RESOURCE    => '',
  DEFAULT_SUB_ARGS => '',
  DEFAULT_OUTPUT_DIR  => '/nfs/nobackup/ensemblgenomes/production/dna_pipelines/data/lmajor-63',
  DEFAULT_CLEANUP     => 'no',	
  ...
  QUEUE_CONFIG => [
    {
      ...
      runner     => '',
      queue => 'production',
      output_dir => '/nfs/nobackup/ensemblgenomes/production/dna_pipelines/data/lmajor-63',
      verbosity => 'INFO',
    ...
    },
 {
     ...
     runner     => '',
     cleanup => 'no',
     output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/data/lmajor-63/Scanprosite',
     runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
     verbosity => 'INFO',
     retry_queue => 'production',
     retry_resource => '',
     retry_sub_args => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/Prints',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/Pfscan',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/Pfam',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/SigP',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/Seg',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/Tmhmm',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  runner     => '',
	  cleanup => 'no',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/Ncoils',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  ...
	  queue      => 'production',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/Tigrfam',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  queue      => 'production',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/Superfamily',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  retry_sub_args => '',
	  ...
	  retry_resource => '',
	  retry_sub_args => '',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/smart',
      },
      {
	  logic_name => 'pirsf',
	  batch_size => 50,
	  ...
	  queue      => 'production',
	  runnabledb_path => 'Bio/EnsEMBL/Analysis/RunnableDB',
	  output_dir => '/nfs/panda/ensemblgenomes/production/protein_pipelines/data/lmajor-63/pirsf',
	  verbosity => 'INFO',
	  retry_queue => 'production',
	  retry_resource => '',
	  retry_sub_args => '',
