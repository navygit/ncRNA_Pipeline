...
%Exonerate = (
	      ...
	      EST_CHUNKDIR                => '/lustre/scratch1/ensembl/fsk/yeast_output/est_chunks',
	      # full path fo the dir where we have the masked-dusted chromosomes
	      EST_GENOMIC                 => '/lustre/scratch1/ensembl/fsk/yeast_output/softmasked_dusted/new/',
	      ...
	      # bonding of version with options here.
              ...
              EST_EXONERATE => {'VERSION' => '/usr/local/ensembl/bin/exonerate-1.0.0',
