...
%EST_GeneBuilder_Conf = (
	    ...
	    EST_GENE_RUNNER   => '/lustre/work1/ensembl/fsk/project_data/yeast/cvs/ensembl-pipeline/scripts/EST/run_EST_GeneBuilder.pl',
	    
            # where the result-directories are going to go	
    	    EST_TMPDIR        => '/lustre/scratch1/ensembl/fsk/yeast_output/tmp',	    
	    ...
	    ESTGENE_TYPE                   => 'estgene',
			 ...
			 EST_GENOMIC      => '/lustre/work1/ensembl/fsk/project_data/yeast/masked_dusted_genome/new',
	    ...
	    EST_REFDBNAME               => 'fsk_yeast_2',
	    EST_REFDBHOST               => 'genebuild4',
	    EST_REFDBPORT               => '3306',
	    ...
	    EST_DBNAME                  => 'fsk_yeast_est',
	    EST_DBHOST                  => 'genebuild5',
	    EST_DBPORT                  => '3306',
	    EST_DBUSER                  => 'ensadmin',
	    EST_DBPASS                  => 'ensembl',

	    # est_gene_db = where we write the genes we produce from e2g transcripts
	    EST_GENE_DBNAME                  => 'fsk_yeast_est',
	    EST_GENE_DBHOST                  => 'genebuild5',
