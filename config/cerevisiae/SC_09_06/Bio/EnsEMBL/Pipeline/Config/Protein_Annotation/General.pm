...
%General = (
	    PA_PEPTIDE_FILE => '/ecs2/scratch2/jb16/yeast/data/peptide.fa', #path to dumped peptides
	    PA_CHUNKS_DIR => '/ecs2/scratch2/jb16/yeast/data/protein_chunks', #path to directory chunks to be written
	    PA_CHUNK_SIZE => 100,
