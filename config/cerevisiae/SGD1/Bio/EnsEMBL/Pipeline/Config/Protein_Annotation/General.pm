...
%General = (
	    PA_PEPTIDE_FILE => '/nfs/acari/jb16/projects/Scerevisiae/data/peptide.fa', #path to dumped peptides
	    PA_CHUNKS_DIR => '/nfs/acari/jb16/projects/Scerevisiae/data/pep_chunks', #path to directory chunks to be written
	    PA_CHUNK_SIZE => 100,
