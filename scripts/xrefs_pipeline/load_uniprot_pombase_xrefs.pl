...
=head1 EXAMPLE
 ...
 perl -I modules scripts/xrefs_pipeline/load_uniprot_pombase_xrefs.pl -host mysql-eg-devel-1 -port 4126
...
use Pod::Usage;
use Bio::EnsEMBL::EGPipeline::Xref::UniProtPomBaseLoader;
use Data::Dumper;
...
my $loader = Bio::EnsEMBL::EGPipeline::Xref::UniProtPomBaseLoader->new(
