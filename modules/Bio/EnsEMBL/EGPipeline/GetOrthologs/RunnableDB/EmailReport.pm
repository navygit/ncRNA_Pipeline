...
Bio::EnsEMBL::EGPipeline::GetOrthologs::RunnableDB::EmailReport
...
=cut
package Bio::EnsEMBL::EGPipeline::GetOrthologs::RunnableDB::EmailReport;
...
sub fetch_input {
    ...
    my $to_sp      = $self->param_required('species');
    my $reports;
